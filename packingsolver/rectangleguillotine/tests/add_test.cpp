...
TEST(RectangleGuillotineBranchingScheme, ApplyInsertion1)
{
    ...
    BranchingScheme::CutInfo c0 {.node = -1, .n = 1, .l = 0, .b = 0, .r = 300, .t = 200};
    BranchingScheme::CutInfo c1 {.node = 0, .n = 1, .l = 0, .b = 0, .r = 300, .t = 200};
    BranchingScheme::CutInfo c2 {.node = 1, .n = 1, .l = 0, .b = 0, .r = 300, .t = 200};
    BranchingScheme::CutInfo c3 {.node = 2, .n = 1, .l = 0, .b = 0, .r = 300, .t = 200};
    EXPECT_EQ(node.curr_cut(0), c0);
    EXPECT_EQ(node.curr_cut(1), c1);
    EXPECT_EQ(node.curr_cut(2), c2);
    EXPECT_EQ(node.curr_cut(3), c3);
    EXPECT_EQ(node.prev_cut(0).node, -1);
    EXPECT_EQ(node.prev_cut(1).node, -1);
    EXPECT_EQ(node.prev_cut(2).node, -1);
    EXPECT_EQ(node.prev_cut(3).node, -1);
    EXPECT_EQ(node.z1(), 0);
    EXPECT_EQ(node.z2(), 0);
    ...
    BranchingScheme::CutInfo c0_1 {.node = -1, .n = 2, .l = 0, .b = 0, .r = 700, .t = 300};
    BranchingScheme::CutInfo c1_1 {.node = 3, .n = 1, .l = 300, .b = 0, .r = 700, .t = 300};
    BranchingScheme::CutInfo c2_1 {.node = 4, .n = 1, .l = 300, .b = 0, .r = 700, .t = 300};
    BranchingScheme::CutInfo c3_1 {.node = 5, .n = 1, .l = 300, .b = 0, .r = 700, .t = 300};
    BranchingScheme::CutInfo c1_1_prev {.node = 0, .n = 1, .l = 0, .b = 0, .r = 300, .t = 200};
    EXPECT_EQ(node.curr_cut(0), c0_1);
    EXPECT_EQ(node.curr_cut(1), c1_1);
    EXPECT_EQ(node.curr_cut(2), c2_1);
    EXPECT_EQ(node.curr_cut(3), c3_1);
    EXPECT_EQ(node.prev_cut(1), c1_1_prev);
    EXPECT_EQ(node.prev_cut(0).node, -1);
    EXPECT_EQ(node.prev_cut(2).node, -1);
    EXPECT_EQ(node.prev_cut(3).node, -1);
    EXPECT_EQ(node.z1(), 0);
...
TEST(RectangleGuillotineBranchingScheme, ApplyInsertion2)
{
    ...
    EXPECT_EQ(node.nodes(), nodes2);
    EXPECT_EQ(node.items(), items2);
    BranchingScheme::CutInfo c0_2 {.node = -1, .n = 2, .l = 0, .b = 0, .r = 700, .t = 200};
    BranchingScheme::CutInfo c1_2 {.node = 0, .n = 2, .l = 0, .b = 0, .r = 700, .t = 200};
    BranchingScheme::CutInfo c2_2 {.node = 1, .n = 2, .l = 0, .b = 0, .r = 700, .t = 200};
    BranchingScheme::CutInfo c3_2 {.node = 3, .n = 1, .l = 300, .b = 0, .r = 700, .t = 200};
    BranchingScheme::CutInfo c3_2_prev {.node = 2, .n = 1, .l = 0, .b = 0, .r = 300, .t = 200};
    EXPECT_EQ(node.curr_cut(0), c0_2);
    EXPECT_EQ(node.curr_cut(1), c1_2);
    EXPECT_EQ(node.curr_cut(2), c2_2);
    EXPECT_EQ(node.curr_cut(3), c3_2);
    EXPECT_EQ(node.prev_cut(3), c3_2_prev);
    EXPECT_EQ(node.prev_cut(0).node, -1);
    EXPECT_EQ(node.prev_cut(1).node, -1);
    EXPECT_EQ(node.prev_cut(2).node, -1);
    EXPECT_EQ(node.z1(), 0);
    ...
    BranchingScheme::CutInfo c0_0 {.node = -1, .n = 3, .l = 0, .b = 0, .r = 700, .t = 800};
    BranchingScheme::CutInfo c1_0 {.node = 0, .n = 3, .l = 0, .b = 0, .r = 700, .t = 800};
    BranchingScheme::CutInfo c2_0 {.node = 4, .n = 1, .l = 0, .b = 200, .r = 500, .t = 800};
    BranchingScheme::CutInfo c3_0 {.node = 5, .n = 1, .l = 0, .b = 200, .r = 500, .t = 800};
    BranchingScheme::CutInfo c2_0_prev {.node = 1, .n = 2, .l = 0, .b = 0, .r = 700, .t = 200};
    EXPECT_EQ(node.curr_cut(0), c0_0);
    EXPECT_EQ(node.curr_cut(1), c1_0);
    EXPECT_EQ(node.curr_cut(2), c2_0);
    EXPECT_EQ(node.curr_cut(3), c3_0);
    EXPECT_EQ(node.prev_cut(2), c2_0_prev);
    EXPECT_EQ(node.prev_cut(0).node, -1);
    EXPECT_EQ(node.prev_cut(1).node, -1);
    EXPECT_EQ(node.prev_cut(3).node, -1);
    EXPECT_EQ(node.z1(), 0);
