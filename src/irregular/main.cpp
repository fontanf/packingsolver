...
int main(int argc, char *argv[])
{
    ...
    desc.add_options()
        ...
        ("use-large-item-first,", po::value<bool>(), "enable large-item-first")
    ...
    if (vm.count("use-large-item-first"))
        parameters.use_large_item_first = vm["use-large-item-first"].as<bool>();
