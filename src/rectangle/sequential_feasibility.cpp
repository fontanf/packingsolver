...
SequentialFeasibilityOutput packingsolver::rectangle::sequential_feasibility(
        ...
        const SequentialFeasibilityParameters& parameters)
{
    ...
    if (instance.objective() == Objective::BinPacking) {
        ...
        for (BinTypeId bin_type_id_iter = 0;
            ...
            Area bin_area = bin_type_iter.rect.x * bin_type_iter.rect.y;
        ...
        current_x = last_bin_type.rect.x;
    }
        ...
        if (instance.objective() == Objective::BinPacking) {
            ...
            for (BinTypeId bin_type_id_iter = 0;
                ...
                BinTypeId sub_bin_type_id = sub_instance_builder.add_bin_type(
                        bin_type_iter.rect.x,
                        bin_type_iter.rect.y);
