 ...
 *
 * One-dimensional specialization of the two-dimensional functions used in
 * 'rectangle/dual_feasible_functions.hpp': a single axis, so no
 * width/height family combination and no item rotation.
 *
 * References:
